<?php
	...
	***********************************************************************************************************/	
	...
	$x["title"] 		= "Stable 1.1"; 	// Title of the Changelogs Release (Version Type / Version Number)
	...
	$x["rows"] 			=  array(); 			// Rows with Changelog Entries in Text Format. (No HTML)
		$x["rows"][$x["rows_counter"]++] 		=  "Support for Suitefish Windows Software by moving Output Folder to __Output";
		$x["rows"][$x["rows_counter"]++] 		=  "Fixed unhandled Exception";